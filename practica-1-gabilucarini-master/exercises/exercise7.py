...
string_concatenado = f'{string_concatenado[0]} {string_concatenado[1]} {string_concatenado[2]} {string_concatenado[3]} {string_concatenado[4]}'
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
string_concatenado, *rest = f'{tupla[0]} {tupla[1]} {tupla[2]} {tupla[3]} {tupla[4]}', tupla[5], tupla[6], tupla[7], tupla[8]
# COMPLETAR - FIN
